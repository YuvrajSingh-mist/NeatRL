...
The agent successfully learns to play Flappy Bird, navigating through pipes with increasing proficiency as training progresses. A video of the trained agent's performance is included ([`final_FlappyBird-v0.mp4`](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/FlappyBird-PPO/final_FlappyBird-v0.mp4)).

![Flappy Bird Agent](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/FlappyBird-PPO/images/output.gif)
