...
#### Pong
![Pong Agent](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/PPO/Atari/images/pong.gif)

*PPO agent playing Pong after 10M training steps - achieving consistent wins against the built-in AI opponent*

#### Bowling
![Bowling Agent](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/PPO/Atari/images/bowling.gif)

*PPO agent playing Bowling after 10M training steps - demonstrating learned bowling strategies and consistent scoring*


#### Boxing
![Boxing Agent](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/PPO/Atari/images/boxing.gif)
...
- [`pong.mp4`](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/PPO/Atari/pong.mp4) - Trained Pong agent gameplay
- [`boxing.mp4`](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/PPO/Atari/boxing.mp4) - Trained Boxing agent gameplay
- [`bowling.mp4`](https://huggingface.co/YuvrajSingh9886/neatrl/resolve/main/artifacts/PPO/Atari/bowling.mp4) - Trained Bowling agent gameplay
