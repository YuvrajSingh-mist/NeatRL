"""Dueling DQN with MLP architecture for discrete-action Gymnasium environments."""
...
class Config:
    # Experiment settings
    """Hyperparameters and settings for Dueling DQN training."""

    exp_name: str = "Dueling-DQN"
    seed: int = 42
...
def train_dueling_dqn(
    ...
    logger.debug("%s\n%s", "Dueling Q-Network Architecture:", q_network)
