"""Advantage Actor-Critic (A2C) with CNN networks for visual Gymnasium environments."""
...
def train_a2c_cnn(
    ...
    """Train a CNN-based A2C agent on pixel observations, returning the trained actor.
